            ...
            <h4 style="font-weight: 500;"> <span style="font-weight: 600;" > Shop name:</span> {{$shop->business_name}}</h4>
                <div class="row col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-group list-group-horizontal catlist mb-3" style="overflow-x: scroll; -ms-overflow-style: none; scrollbar-width: none; white-space: nowrap;">
                            @if (count($product_size)>0)
                            @foreach ($product_size as $item)
                                {{-- SIZES --}}
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                    <label class="form-check-label" for="inlineRadio1">{{$item->product_size}}</label>
                                </div>
                            @endforeach
                            @endif
                        </ul>
                        ...
                        <ul class="list-group list-group-horizontal catlist mb-3" style="overflow-x: scroll; -ms-overflow-style: none; scrollbar-width: none; white-space: nowrap;">
                            ...
                            @foreach ($product_color as $item)
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                    <label class="form-check-label" for="inlineRadio1">{{$item->product_color}}</label>
                                </div>
                            @endforeach
                            @endif
                        </ul>
                        <div class="d-flex justify-content-between" style="bottom: 0px">
                            ...
                            <button class="btn cecra_btn mr-2" type="button" id="button-addon1">Add to cart</button>
                            <button class="btn cecra_btn" type="button" id="button-addon1">Buy now</button>
