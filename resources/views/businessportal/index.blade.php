                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="LL">{{ trans('sentence.business.store.label.coverImage') }} &nbsp;<span class="text-danger"></span></label><br/>
                                            <img width="250px" height="250px;" src="{{ isset($businessUserInfo['coverimage']) ? URL::asset('assets/images/vendors/'.$businessUserInfo['coverimage']) : URL::asset('assets/images/placeholder.png') }}" src="" alt=""/>
                                            <br><br/>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="Lb">{{ trans('sentence.business.store.label.uploadNew') }}</label>
                                                    <input id="Lb" type="file" name="cover_image" class="form-control" accept="image/*">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="">{{ trans('sentence.business.store.label.shopIcon') }} &nbsp;<span class="text-danger"></span></label><br/>
