                        ...
                        <div class="profile-widget">
                            ...
                            <div class="pro-content">
                                <div class="pro-content">
                                    ...
                                    <div class=" row-sm">
                                        <h4 class="speciality text-center">D market 11-s2</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-widget">
                            ...
                            <div class="pro-content">
                                <div class="pro-content">
                                    ...
                                    <div class=" row-sm">
                                        <h4 class="speciality text-center">ck street x21</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-widget">
                            ...
                            <div class="pro-content">
                                <div class="pro-content">
                                    ...
                                    <div class=" row-sm">
                                        <h4 class="speciality text-center">Food market shop 34</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-widget">
                            ...
                            <div class="pro-content">
                                <div class="pro-content">
                                    ...
                                    <div class=" row-sm">
                                        <h4 class="speciality text-center">C-11 street 45</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-widget">
                            ...
                            <div class="pro-content">
                                <div class="pro-content">
                                    ...
                                    <div class=" row-sm">
                                        <h4 class="speciality text-center">New Town 45-g-1</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<section class="section section-doctor bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                        <h3 class="row my-5 p-4">CLOSE TO ME Local Businesses</h3>
            </div>
