                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="display: flex" class="mb-2" id="color_{{ $item->vendor_product_color_id }}">
                                ...
                                <button type="button" style="background: red;border:none;outline:none" onclick="deleteColor('color_{{ $item->vendor_product_color_id }}')">Remove</button>
                            </div>
                            @endforeach
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="display: flex" class="mb-2" id="size_{{ $item->vendor_product_size_id }}">
                                ...
                                <button type="button" style="background: red;border:none;outline:none" onclick="deleteSize('size_{{ $item->vendor_product_size_id }}')">Remove</button>
                            </div>
                            {{-- <input type="text" class="form-control" name="sizes[]" value="{{ $item->product_size }}"> --}}
                            @endforeach
                            </div>
                ...
                <div class="card bg-white" style="margin-top: 0px !important;padding:0">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card bg-white" style="margin-top: 0px !important;padding:0">
                                    <img class="card-img-top" src="{{ URL::asset('assets/images/product_images/'.$item->vendor_product_image) }}" alt="Card image cap">
                                    {{-- <div class="card-body">
