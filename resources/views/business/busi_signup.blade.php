...
<script>
  ...
  gtag('config', 'UA-177851318-1');
	...
	<!-- Bootstrap CSS -->
	<title>Crea Tu Cuenta | Cerca de Mi</title>
					...
					<div class="row register-form m-5">
						...
						<div class="col-md-6">
							<div class="form-group">
                                ...
                                <input id="input-password" type="password" class="form-control  @error('password') is-valid @enderror" name="password" value="{{ old('password') }}" required />
								...
								<div class="form-group">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="defaultCheck1">
                                            {{trans('sentence.signup.iConfirmed')}} <a href="{{route('terminos-y-condiciones-negocios')}}" class="text-info">{{trans('sentence.footer.termsAndConditions')}}</a>
                                        </label>
                                    </div>
                                    @error('confirmed')
                                        <span class="text-danger"><i class="fas fa-info-circle"></i> {{ $message }}</span>
