...
{{--
                    ...
                    <li class="nav-item">
                         <a class="nav-link" href="{{route('bus/dashboard')}}">
                    ...
                    {{--  <li class="nav-item">
                        <div class="nav-link">
                            <a  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  <img class="img-profile-nav border" src="{{ session()->get('businessuser_info')['image'] }}"></a>
                            <div class="dropleft">
                                <div class="dropdown-menu shadow my-n4" style="margin-left:860px;" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item " href="{{ route('bus/signout') }}">{{ trans('sentence.Logout') }}</a>
                                </div>
                            </div>
                        </div>
                    </li>  --}}
