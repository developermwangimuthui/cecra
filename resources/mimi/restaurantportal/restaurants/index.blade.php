 ...
 -->
                           {{--  <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <img width="200" src="{{$businessUserInfo['thumb']}}" alt=""  data-placeholder="{{$businessUserInfo['placeholder']}}"/>
                                    <br><br/>
                                    <div class="row">
                                        <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img width="100%" src="{{$businessUserInfo['bthumb']}}" alt=""  data-placeholder="{{$businessUserInfo['placeholder']}}/>
                                    <br><br/>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label for="">{{ trans('sentence.business.store.label.uploadNew') }}</label>
