...
{{--                        <a href="{{route('shop.product') }}" class="btn takfua-back text-white">{{ trans('sentence.business.product.label.back') }}</a>--}}
                        ...
                        <div class="table-responsive">
                            <table id="images" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    <td class="d-none d-lg-table-cell text-left">{{ trans('sentence.restaurant.menu.label.image') }}</td>
                                ...
                                <tr>
                                    <td colspan="1"></td>
                                    <td class="text-right"><button type="button" data-toggle="tooltip" title="Add" class="btn btn-primary addImage"><i class="fa fa-plus-circle"></i></button></td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
